export const REFERENCE_SOIL = Object.freeze({ id: 'synthetic-rigid-loam-si-v1',
  thetaR: 0.05, porosity: 0.45, alphaPerM: 2, n: 2, ksMPerS: 1e-4,
  ell: 0.5, minHeadM: -4, maxHeadM: 8, densityKgM3: 1000 });
...
export function createSoil(input = REFERENCE_SOIL) {
  requireCondition(input && Object.keys(input).sort().join('|') ===
    Object.keys(REFERENCE_SOIL).sort().join('|'), 'exact soil definition fields');
