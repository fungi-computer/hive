...
export function geometry({ nx, nz, dx, hx, hz, depth = 2, periodicX = false,
  ...
  const g = { version: 'mac-boussinesq-2d-v2-metric', nx, nz, metric, n, volume,
  ...
  g.identity=JSON.stringify({version:g.version,nx,nz,metric,periodicX,periodicZ,
