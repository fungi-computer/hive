...
for name in ['run-capture-v1.py', 'COMPILE-HANDOFF.json', 'SOURCE-PIN.json']:
    shutil.copyfile(ROOT / name, OUT / name)
env = os.environ.copy()
env['OMP_NUM_THREADS'] = '1'
command = [str(ROOT / 'build-v1/sealed-heat')]
receipt = {'scope': 'One fixed sealed 512-cell room, finite 100 J heater, 2 s horizon.',
           ...
           'binary': pin(ROOT / 'build-v1/sealed-heat'), 'runner': pin(Path(__file__)),
