...
SRC=ROOT.parent.parent.parent.parent/'sph-library-fit/basilisk-native-v1/basilisk/src'
OUT=ROOT/'build-v1'
def pin(p):
    b=p.read_bytes();return {'bytes':len(b),'sha256':hashlib.sha256(b).hexdigest()}
checkpoint=json.loads((ROOT/'SOURCE-PIN.json').read_text())
...
shutil.copyfile(ROOT/'SOURCE-PIN.json',OUT/'SOURCE-PIN.json')
