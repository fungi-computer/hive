...
// Codes come from the height/sea sampler: below datum, dry datum ground, or
// above-datum land. This palette does not infer water from a shaping feature.
  ...
  output.querySelector("[data-field=selection]").textContent = JSON.stringify(
    {
      ...
      sharedSampler: {
        ...
        surfaceWaterPotentialDepthLevels: selectedShared.surfaceWaterPotentialDepthLevels,
      ...
      sharedLocalSampler: {
        ...
        surfaceWaterPotentialDepthLevels: selectedLocal.surfaceWaterPotentialDepthLevels,
