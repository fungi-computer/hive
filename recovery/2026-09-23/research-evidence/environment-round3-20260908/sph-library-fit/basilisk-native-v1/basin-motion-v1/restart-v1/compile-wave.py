...
for name in ("wave.c", "wave-observation.h", "wave-reduced-observation.h", "wave-transport-observation.h", "compile-wave.py", "source-pins.json"):
...
receipt = {"scope": "Compile only of isolated transport-accounted reduced-gravity caller; no fixed wave case executed.",
