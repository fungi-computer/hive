...
def inspect_force(capture):
    ...
    controls = {
        ...
        "originalAndCleanupAccountedBalance": True,
    ...
    for index, r in enumerate(forces):
        ...
        controls["originalAndCleanupAccountedBalance"] &= abs(w["waterM3PerMetre"] - .54) <= 1e-10 and \
            abs(w["airM3PerMetre"] - .54) <= 1e-10 and \
            finite(r["waterDriftAfterNativeClampM3PerM"]) and abs(r["waterDriftAfterNativeClampM3PerM"]) <= 1e-10 and \
