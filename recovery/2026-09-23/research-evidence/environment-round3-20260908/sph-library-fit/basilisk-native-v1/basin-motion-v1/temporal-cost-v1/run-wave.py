...
for case_name in ("coarse", "fine"):
    ...
    item = {"caseName": case_name, "exitCode": code, "timedOut": timed_out,
            ...
            "childUserCpuSeconds": cpu_after.ru_utime - cpu_before.ru_utime,
            "childSystemCpuSeconds": cpu_after.ru_stime - cpu_before.ru_stime,
            "childPeakRssKiBProcessCumulative": cpu_after.ru_maxrss,
...
receipt = {"scope": "One fixed reduced-gravity 2D wave fixture, two serial meshes; no ledge/3D/restart qualification.",
           "invocationId": env.get("INVOCATION_ID"), "combinedNativeCeilingSeconds": 60,
