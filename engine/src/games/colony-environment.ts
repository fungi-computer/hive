  ...
  structures: {
    ...
    catalog: [
      ...
      { id: "timber-shelf", shape: { kind: "fixture", footprint: [[0, 0], [1, 0]] }, workReachBelowCells: 0, materials: [{ kind: "wood", quantity: 3 }], workSeconds: 4,
        onComplete: { components: [{ name: "hive.visual", value: { sprite: "colony.timber-shelf", label: "Timber shelf" } }], ports: [{ key: "storage", at: "site-contact", components: [{ name: "hive.container", value: { capacity: 12 } }, { name: "hive.stockpile-cell", value: { zone: "ground-zone", priority: 4, filterProfile: "materials" } }] }] } },
    ],
  },
  materials: [
    {
