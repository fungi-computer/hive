...
import { Container, FiniteResource, MaterialLot, Position } from "../sdk/common";
...
export function createColonyStockpileSystem(filterProfiles: Readonly<Record<string, StockpileFilterProfile>>) {
  return system({
    ...
    reads: [StockpileCell, GroundStock, FiniteResource, MaterialLot, DeliveryTask, Container, Position, SealedContainer],
    writes: [DeliveryTask],
