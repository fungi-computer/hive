...
function fixture(processes: readonly [EntityId, EntityId], lotQuantity = 2) {
  ...
  const processRows = processes.map(id => row(id, { [StagedProcess.id]: { version: 1, definition: "ale", definitionVersion: 1, station: `${id}.station`, stageIndex: 0, progressSeconds: 0, enteredTick: 0, phase: "waiting", blockedReason: "" } }));
