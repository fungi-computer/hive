...
function context(rows: Row[]) {
  ...
  const fake = {
    ...
    worldPoses: () => [], routeCosts: () => [], physicalContacts: () => { throw new Error("unexpected physical contact query in this fixture"); }, terrainMaterials: () => [], terrainSurfaces: () => [], structureSurfaces: () => [], assign: () => [],
    write: () => {}, action: () => {},
