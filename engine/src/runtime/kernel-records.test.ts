...
const entity = JSON.stringify({ format: "hive-kernel", version: 8, revision: 7, time: 1.5, scene: { format: "hive-game", version: 1, game: "colony", components: [], initial: [] }, next_work_generation: 1, work_attempts: [] });
