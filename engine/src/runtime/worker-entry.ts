...
export function installWorkerRuntime(
  scope: {
    onmessage: ((event: MessageEvent<WorkerCommand | WorkerPlacementCommand | WorkerTerrainRegionsCommand>) => void) | null;
...
const early: MessageEvent<WorkerCommand | WorkerPlacementCommand | WorkerTerrainRegionsCommand>[] = [];
