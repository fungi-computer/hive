...
export default defineConfig({
  ...
  build: {
    ...
    emptyOutDir: true,
    rollupOptions: {
      input: Object.fromEntries(["index", "colony", "colony-performance", "survival", "formations", "pirates", "mixed-render-review", "spatial-render-review"].map(name => [name, resolve(engine, `${name}.html`)])),
    },
  },
});
