...
| Trees and wood              | `world.js`, `orders.ts`, `jobs.ts`, `activity.ts`                   | generated/content entities, generic finite work, native material output and delivery                                                                | Three authored trees already support worker-independent designation, native route/contact, fell/chop stages, six conserved wood and ordinary hauling. Restore a generated living population, path/scenery composition and remaining pickup/drop presentation; do not create another tree job path.                                                                                                                            |
| Storage                     | retained lot/container and storage jobs                             | native containers, delivery tasks and data-defined stockpile filters                                                                                 | Floor stockpile rectangles, wood/food filters, priorities, native floor/conflict admission, physical hauling and reload already exist. Complete the richer policy UI/material profiles and shared parallel haul-leg correction; do not fall back to crates as the policy owner.                                                                                                                                               |
| Construction                | `construction.js`, `physical-completion.ts`, `construction-view.js` | native construction work, physical geometry, material consumption, support query and completion recipes                                              | The seven-entry catalog, four-facing stairs, wall lines, floor/roof rectangles, bed/shelf/station ports, deconstruction and salvage exist. The current three-level stair/floor/stair source path completes and conserves embodied lumber after the cardinal-anchor correction; deployment and sustained play remain open. Bed/shelf use plus contextual presentation are incomplete. Fix those callers over the current native completion/support owner rather than replacing the catalog. |
...
| Brewing                     | `recipes.ts`, `brewing.ts`, brew jobs/activity                      | native staged processes, lots/containers, finite field water, paid emissions and shared attendance/supply                                             | One full groundwater-to-pail-to-kettle-to-four-ale-and-spent-grain journey is live. Remove the free mugwort by joining real sow/water/grow/harvest, then restore serving and consumption through ordinary needs. The manual hearth path is deleted; all further recipes reuse the same process owner.                                                                                                                          |
...
| Presentation and juice      | `art/clearing.js`, `art/figures.js`, `view.js`                      | shared original asset pack, visual projection, interpolation, cues/effects                                                                          | Original workers, tree stages, carried-object poses, brew-station profiles and the wandering cat are bound. The generated worn path, denser scenery, pickup/drop transitions and several contextual object actions remain missing. Presentation reads committed physical facts and never advances work.                                                                                                                        |
