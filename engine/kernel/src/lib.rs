...
impl WasmKernel {
    ...
    pub fn party_join_identity(&self, json: &str) -> Result<String, JsValue> {
        self.0.party_join_identity_json(json).map_err(js_error)
    }
    ...
    pub fn water_contacts(&mut self, input: &str) -> Result<String, JsValue> {
        self.0.water_contacts_json(input).map_err(js_error)
    }
    pub fn structure_surfaces(&mut self, input: &str) -> Result<String, JsValue> {
        self.0.structure_surfaces_json(input).map_err(js_error)
    }
    pub fn terrain_changes(&self, input: &str) -> Result<String, JsValue> {
        self.0.terrain_changes_json(input).map_err(js_error)
    }
    ...
    pub fn floor_operations(&mut self, input: &str) -> Result<String, JsValue> {
        self.0.floor_operations_json(input).map_err(js_error)
    }
    pub fn route_costs(&mut self, input: &str) -> Result<String, JsValue> {
        self.0.route_costs_json(input).map_err(js_error)
    }
    pub fn route_to_any(&mut self, input: &str) -> Result<String, JsValue> {
        self.0.route_to_any_json(input).map_err(js_error)
    }
