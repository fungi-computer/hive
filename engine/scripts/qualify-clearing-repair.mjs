...
const groups = Object.freeze({
  ...
  work: Object.freeze([
    "engine/src/sdk/behavior.test.ts",
    ...
    "engine/src/games/formations-behavior.test.ts",
  ]),
  ...
  drawing: Object.freeze([
    ...
    "engine/src/client/draw-record-facts.test.js",
    "engine/src/client/spatial-draw-order.test.js",
    "engine/src/client/spatial-scene-owner.test.js",
  ...
  terrain: Object.freeze([
    ...
    "engine/src/client/terrain-face-appearance.test.js",
