// Original three-cell loft stair: a cleated timber ramp with a clear top landing.
...
function side(parent, x) {
  ...
  box(parent, "#bc945f", x, STOREY_HEIGHT + 0.6, 2.2, 0.085, 0.075, 0.4);
}
