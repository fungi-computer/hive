...
Botanical CTO retired the old Game lane terminals after explicit release and
identity checks; resumable sessions/evidence remain preserved. Only Botanical
CTO and Game CTO share the current Herdr screen. The unrelated modified proof script and 19
