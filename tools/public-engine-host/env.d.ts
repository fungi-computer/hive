/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=tools/public-engine-host/wrangler.json tools/public-engine-host/env.d.ts` (hash: 3741da0ce1912a57c27d5c4dc0ca5377)
// Runtime types generated with workerd@1.20260828.1 2026-09-04 
interface __BaseEnv_Env {
	IMPLEMENTATION_HASH: "";
	PUBLIC_ORIGIN: "";
	REGIONS: DurableObjectNamespace<import("./worker").PublicEngineRegion>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "PublicEngineRegion";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "IMPLEMENTATION_HASH" | "PUBLIC_ORIGIN">> {}
}
