/** Stateless Shiitake/Mycelium capability consumer for the existing Survival
 * public pack. The existing public engine DO retains all simulation authority. */
import type { DynamicWorkerExecutorOptions } from "@cloudflare/codemode";
import { z } from "zod";
import { survivalController } from "./survival.mts";
...
export default {
  async fetch(request: Request, env: Environment) {
    ...
    const module = survivalController({
      endpoint: "https://engine.local/v1/survival",
