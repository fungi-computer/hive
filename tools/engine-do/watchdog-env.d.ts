/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=watchdog.wrangler.json watchdog-env.d.ts` (hash: 48102783b80e9c4b5f87fb9567995e36)
// Runtime types generated with workerd@1.20260828.1 2026-09-04 
interface __BaseEnv_Env {
	REGIONS: DurableObjectNamespace<import("./watchdog-worker").WatchdogQuarry>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./watchdog-worker");
		durableNamespaces: "WatchdogQuarry";
	}
