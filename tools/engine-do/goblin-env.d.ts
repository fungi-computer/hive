/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=goblin.wrangler.json goblin-env.d.ts` (hash: 14615236077f9071f07391df0f5e6fc4)
// Runtime types generated with workerd@1.20260828.1 2026-09-04 
interface __BaseEnv_Env {
	REGIONS: DurableObjectNamespace<import("./goblin-worker").GoblinRegion>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./goblin-worker");
		durableNamespaces: "GoblinRegion";
	}
